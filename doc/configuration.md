...
- **ATAK/TAK Server Integration** allows sending Cursor on Target (CoT) alerts to TAK servers when potential Stingray activity is detected. See [ATAK Integration](./atak-integration.md) for detailed configuration.
